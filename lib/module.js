...
module.exports = function (moduleOptions) {
  ...
  console.log('NUXT-IUBENDA-INIT')
  console.log('---------------------------------')
  console.log(this.nuxt.context)
  console.log('---------------------------------')
  console.log('this.options.i18n.locale')
  console.log(this.options.i18n.locale)
  console.log('---------------------------------')
  console.log('this.nuxt.context.app.i18n.locale')
  console.log(this.nuxt.context.app.i18n.locale)
  console.log('---------------------------------')
  console.log('this.nuxt.context.i18n.locale')
  console.log(this.nuxt.context.i18n.locale)
  console.log('---------------------------------')
  moduleOptions.config.lang = this.options.i18n.locale || 'en'
